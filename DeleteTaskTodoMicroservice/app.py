...
connection_string = "Driver={ODBC Driver 18 for SQL Server};Server=tcp:siddharthsql-dev.database.windows.net,1433;Database=siddharthdb-dev;Uid=devopsadmin;Pwd=P@ssw01rd@123;Encrypt=yes;TrustServerCertificate=no;Connection Timeout=30;"
